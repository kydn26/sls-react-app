...
import accesibilityFacilitesData from "./data/accesibility-facilities.json";
    ...
    <div className="scene" id="hotelinfo">
      ...
      <article id="usefulinfo">
        ...
        <section className="checklist" id="accessibility">
          ...
          <ul>
            {accesibilityFacilitesData.map((facilities, index) => {
              return <li key={index}>{facilities.name}</li>;
            })}
          </ul>
        </section>
      </article>
